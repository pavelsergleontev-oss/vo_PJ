...
# целевая переменная: 1, если SI > 8 эффективное лекарство, иначе 0
target_col = 'SI'
...
print("=== ЗАДАЧА: Классификация SI > 8 (Поиск перспективных молекул) ===")
print(f"ВНИМАНИЕ: Дисбаланс классов!\n{y.value_counts()}\n")

# обучение моделей и оценка
# class_weight='balanced', чтобы модели обращали  внимания на редкий класс SI > 8
models = {
